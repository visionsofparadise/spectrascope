...
export function processBiquad(sample: number, coefficients: BiquadCoefficients, state: BiquadState): number {
	const out =
...
export function computeKWeightingCoefficients(sampleRate: number): KWeightingCoefficients {
	return {
