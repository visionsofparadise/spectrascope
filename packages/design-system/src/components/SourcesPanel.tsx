	...
	return (
		<div className="flex h-full flex-col bg-void">
			{/* Header — letter-spaced technical caps for the section label. Fixed
			    `h-10` so it lines up exactly with the workspace's ViewTabs strip
			    across the divider-free shell; no border — the panel shares the
			    void surface seamlessly with the workspace. */}
